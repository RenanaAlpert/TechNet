...
public class ReportMalfunctionFragment extends Fragment {
    ...
    private ReportMalfunctionViewModel reportMalfunctionViewModel;
    private FragmentReportMalfunctionMaintenanceManBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        reportMalfunctionViewModel =
                new ViewModelProvider(this).get(ReportMalfunctionViewModel.class);
        ...
        reportMalfunctionViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
